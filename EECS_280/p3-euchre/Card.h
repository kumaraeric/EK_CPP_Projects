...
public:
  ...
  Card(const std::string &rank_in, const std::string &suit_in); //done

  //EFFECTS Returns the rank
  std::string get_rank() const; //done

  //EFFECTS Returns the suit.  Does not consider trump.
  std::string get_suit() const; //done

  //REQUIRES trump is a valid suit
  //EFFECTS Returns the suit
  //HINT: the left bower is the trump suit!
  std::string get_suit(const std::string &trump) const; //done

  //EFFECTS Returns true if card is a face card (Jack, Queen, King or Ace)
  bool is_face() const; //done

  //REQUIRES trump is a valid suit
  //EFFECTS Returns true if card is the Jack of the trump suit
  bool is_right_bower(const std::string &trump) const; //done

  //REQUIRES trump is a valid suit
  //EFFECTS Returns true if card is the Jack of the next suit
  bool is_left_bower(const std::string &trump) const; //done

  //REQUIRES trump is a valid suit
  //EFFECTS Returns true if the card is a trump card.  All cards of the trump
  // suit are trump cards.  The left bower is also a trump card.
  bool is_trump(const std::string &trump) const; //done
